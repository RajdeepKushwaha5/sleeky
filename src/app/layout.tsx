...
import { fontMono, fontSans, fontSerif, fontSpaceGrotesk } from "@/lib/fonts";
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${fontSans.variable} ${fontSerif.variable} ${fontMono.variable} ${fontSpaceGrotesk.variable}`}
