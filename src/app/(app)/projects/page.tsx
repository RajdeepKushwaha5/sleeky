...
export default function ProjectsPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      {/* GitHub CTA */}
      <section className="mt-16 rounded-2xl border border-border/25 bg-card/30 p-8 text-center">
        <div className="mx-auto max-w-md space-y-4">
          <div className="mx-auto flex size-12 items-center justify-center rounded-full border border-border/25 bg-foreground/5">
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-border/25 bg-foreground/5 px-5 py-2.5 text-sm font-medium text-foreground/80 transition-colors hover:bg-foreground/10"
          >
