  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      <div className="mb-12 space-y-4">
        <div className="inline-flex items-center gap-2 rounded-full border border-border/15 bg-foreground/[0.03] px-3 py-1 text-xs font-medium text-foreground/60">
      ...
      {featuredProjects.length > 0 && (
        <section className="mb-16">
          <div className="mb-6 flex items-center gap-3">
            <h2 className="font-mono text-xs font-medium tracking-wider text-foreground/50 uppercase">
      ...
      {/* GitHub CTA */}
      <section className="mt-16 rounded-2xl border border-border/15 bg-foreground/[0.02] p-8 text-center">
        <div className="mx-auto max-w-md space-y-4">
            <div className="mx-auto flex size-12 items-center justify-center rounded-full border border-border/15 bg-foreground/[0.04]">
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <p className="text-sm text-foreground/60">
            These are just a few highlights. Check out my GitHub profile for
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-border/15 bg-foreground/[0.04] px-5 py-2.5 text-sm font-medium text-foreground/80 transition-colors hover:bg-foreground/[0.07]"
          >
