...
export function OSSContributionItem({
  ...
  return (
    <div className="group/oss flex items-center hover:bg-accent2">
      ...
      <div className="flex flex-1 items-center gap-3 overflow-hidden border-l border-dashed border-border/10 py-3.5 pr-4 pl-4">
        ...
        <a
          ...
          className="flex size-8 shrink-0 items-center justify-center rounded-lg text-muted-foreground/50 transition-all duration-200 hover:text-foreground"
