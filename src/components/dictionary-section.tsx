      ...
      <div className="screen-line-before screen-line-after mx-auto border-x border-edge md:max-w-3xl">
        ...
        >
          ...
          <div className="relative mb-6">
            <div className="absolute left-0 right-0 top-1/2 h-px bg-gradient-to-r from-transparent via-zinc-300 to-transparent dark:via-zinc-700" />
            <div className="relative mx-auto w-fit bg-background px-4">
              <div className="flex items-center gap-2 font-mono text-xs text-muted-foreground">
                <span className="text-zinc-400 dark:text-zinc-600">/ˈdɪk.ʃən.er.i/</span>
                <span className="text-zinc-300 dark:text-zinc-700">•</span>
                <span className="italic text-zinc-400 dark:text-zinc-600">noun, informal</span>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-2xl">
            <div className="rounded-lg border border-edge bg-muted/30 p-6">
              <div className="mb-2 flex items-baseline gap-2">
                <span className="font-mono text-sm font-bold text-foreground">def.</span>
                <span className="font-mono text-xs text-muted-foreground">1.</span>
              </div>
              <p className="leading-relaxed text-foreground/90">
                A bold, carefree expression used to convey abandoning worry or hesitation and fully committing to an action or challenge, often with confidence, risk-taking, or enjoyment.
              </p>
            </div>
          </div>
          ...
          <div className="mx-auto mt-6 flex max-w-2xl items-center gap-2">
            ...
            <div className="font-mono text-xs text-zinc-400 dark:text-zinc-600">◇</div>
          ...
          <div className="relative mx-auto mt-4 max-w-2xl">
            <div className="absolute -left-2 -top-2 h-4 w-4 border-l-2 border-t-2 border-zinc-300 dark:border-zinc-700" />
            <div className="absolute -right-2 -top-2 h-4 w-4 border-r-2 border-t-2 border-zinc-300 dark:border-zinc-700" />
            <div className="absolute -bottom-2 -left-2 h-4 w-4 border-b-2 border-l-2 border-zinc-300 dark:border-zinc-700" />
            <div className="absolute -bottom-2 -right-2 h-4 w-4 border-b-2 border-r-2 border-zinc-300 dark:border-zinc-700" />
          </div>
        </motion.div>
      </div>
    </div>
