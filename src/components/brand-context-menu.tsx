...
import { getWordmarkSVG } from "./rajdeep-singh-wordmark";
import { getMarkSVG,RJDPMark } from "./rjdp-mark";
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuItem,
  ...
  return (
    <ContextMenu>
      ...
      <ContextMenuContent className="w-64">
        ...
        <ContextMenuItem asChild>
          <a href="https://assets.rajdeepsingh.dev/rajdeep-brand.zip" download>
            <DownloadIcon />
