  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        ...
        "bg-zinc-100 text-muted-foreground dark:bg-white/[0.04] dark:ring-1 dark:ring-white/[0.08]",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-white data-[state=active]:text-foreground dark:data-[state=active]:bg-white/[0.1] dark:data-[state=active]:text-foreground",
        className
      )}
      {...props}
    />
