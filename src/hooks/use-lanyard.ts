  ...
  useEffect(() => {
    ...
    const connect = () => {
      try {
          ...
          switch (message.op) {
            ...
            case 0: // Event
              if (
                ...
                console.log("📡 Lanyard update:", {
                  spotify: message.d.listening_to_spotify,
                  discord_status: message.d.discord_status,
                  activities: message.d.activities?.length || 0,
                });
                setData(message.d);
                setIsLoading(false);
              }
        ...
        ws.onclose = () => {
          console.log(
            "🔴 Lanyard WebSocket disconnected, reconnecting in 5s..."
          );
